...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
      let red_cast = u8::try_from(tuple.0).unwrap();
      let green_cast = u8::try_from(tuple.1).unwrap();
      let blue_cast= u8::try_from(tuple.2).unwrap();

      return Ok(Color {red:red_cast,green:green_cast,blue:blue_cast});
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        let red_cast = u8::try_from(arr[0]).unwrap();
        let green_cast = u8::try_from(arr[1]).unwrap();
        let blue_cast= u8::try_from(arr[2]).unwrap();
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let red_cast = u8::try_from(slice[0]).unwrap();
        let green_cast = u8::try_from(slice[1]).unwrap();
        let blue_cast= u8::try_from(slice[2]).unwrap();
